...
function spaceLogoPicker(){
    return {
        restrict: 'A',
        templateUrl: 'views/configuration/space_config/space_logo_picker.html',
        controller: spaceLogoPickerCtrl
    };
}
...
angular
    ...
    .directive('spaceLogoPicker',spaceLogoPicker);
